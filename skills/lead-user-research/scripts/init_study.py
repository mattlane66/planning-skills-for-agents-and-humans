...
def main() -> int:
    ...
    write_json(
        root / "manifest.json",
        {
            ...
            "evidence_completion": "NOT_STARTED",
    ...
    write_json(
        root / "decision.json",
        {
            ...
            "brief_field_status": {
                ...
                "target_market": "USER_SUPPLIED" if args.target_market else "UNKNOWN",
                "what_to_understand": "USER_SUPPLIED" if args.understand else "UNKNOWN",
                "decision": "USER_SUPPLIED",
                "innovation_altitude": "USER_SUPPLIED" if args.innovation_altitude else "UNKNOWN",
            },
