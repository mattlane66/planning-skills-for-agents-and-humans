...
require_text templates/context-packet.md "A kickoff doc is not build scope or sequence"
...
require_text mcp-server/src/server.ts "templates/context-packet.md"
require_text mcp-server/src/server.ts "templates/dumplink.md"
...
require_text mcp-server/src/server.ts "skill-metadata.json"
require_text plugin.json "https://agent-plugins.org/schemas/1.0.0/plugin.schema.json"
require_text mcp.json "https://agent-plugins.org/schemas/1.0.0/mcp.schema.json"
require_text mcp.json "https://planning-skills-mcp-production.up.railway.app/mcp"
require_text mcp-server/src/http-server.ts "StreamableHTTPServerTransport"
require_text mcp-server/src/server.ts "readOnlyHint: true"
require_text mcp-server/src/server.ts "openWorldHint: false"
